...
class PaymentCommissionCalculator:
    ...
    def calculate_for_payment(self, 
                             processo: str,
                             valor_recebido: float,
                             process_context: Dict) -> List[Dict]:
        """
        ...
        """
        # DEBUG
        print(f"[DEBUG Calculator] Processo: {processo}, Valor: {valor_recebido}")
        print(f"[DEBUG Calculator] Contexto: {process_context}")
        print(f"[DEBUG Calculator] Set recebe_por_recebimento_norm: {self.recebe_por_recebimento_norm}")
        ...
        print(f"[DEBUG Calculator] Colaboradores encontrados: {len(colaboradores)}, detalhes: {colaboradores}")
    ...
    def _get_gestao_colaboradores(self, process_context: Dict) -> List[Dict]:
        ...
        try:
            ...
            mask = (
                ...
                (atribuicoes_gestao['tipo_mercadoria'] == process_context.get('tipo_mercadoria'))
            )
